...
<table width="1050px" align="center"  border="1">
  <tbody>
    <tr>
      <th height="39" colspan="2" style="background-color:#4E4E4E"><div style="text-align:left;color:#FFFFFF"><b><font size="+3"><a href="index.php" style="text-decoration:none ; color:#FFFFFF">ARMY Institute of technology </a></font></b><marquee direction="left" height="100%">
			AIT PUNE , DIGHI HILLS </marquee></div></th>
    </tr>
    <tr>
...
<li><img src="data1/images/banner_01.jpg" alt="Entrance" title="Entrance" id="wows1_0"/></li>
<li><img src="data1/images/highlightnews.jpg" alt="International Accredition" title="International Accredition" id="wows1_1"/></li>
<li><img src="data1/images/img21644.jpg" alt="Raman Theatre" title="Raman Theatre" id="wows1_2"/></li>
<li><img src="data1/images/url.jpg" alt="BCJ Hall" title="BCJ Hall" id="wows1_3"/></li>
</ul></div>
<div class="ws_bullets"><div>
<a href="#" title="Multispeciality College Campus"><img src="data1/tooltips/banner_01.jpg" alt="Entrance"/>1</a>
<a href="#" title="International Accredition"><img src="data1/tooltips/highlightnews.jpg" alt="International Accredition"/>2</a>
<a href="#" title="Best Overall Employement"><img src="data1/tooltips/img21644.jpg" alt="Raman Theatre"/>3</a>
<a href="#" title="Best Of Class Infrastructure"><img src="data1/tooltips/url.jpg" alt="BCJ Hall"/>4</a>
</div></div>
<span class="wsl"></span>
  ...
  <a href="logout.php" style="text-decoration:none;margin-left:150px;"><input type="submit" value="Logout" name="logout"></a></td>
    ...
    <tr>
      <td height="25" colspan="2" style="background-color:#B8AFFF"><center><b>&copy; 2016 by Ajay | Managed by Ankur</b></center></td>
    </tr>
  </tbody>
</table>
</html>